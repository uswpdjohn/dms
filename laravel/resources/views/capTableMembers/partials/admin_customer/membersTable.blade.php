...
<div class="select-pagination-portion table-top-portion row g-0">
    <div class="sb-part search-box-part col-12 col-md-4 offset-lg-1 col-lg-5">
        <form action="" method="GET" id="member_search_form">
            <div class="d-flex form-inputs search-data">
                <input class="form-control" type="text" name="member_search" placeholder=" Search" id="member_search"   value="{{request()->has('member_search') ? request()->get('member_search') : ''}}">
    ...
    <div class="od-part col-12 offset-md-2 col-md-6 offset-lg-4 col-lg-3">
        ...
        <input type="date" id="asOnDate" onchange="getAsOnDateData(this.value)" class="form-control-sm my-1">
    </div>
</div>
...
{{--        @if($membersData['data']->currentPage() > 1)--}}
{{--            <a href="{{$membersData['data']->previousPageUrl()}}" data-href="" class="btn left-arrow" id="left-arrow"><i class="fa-solid fa-chevron-left"></i></a>--}}
{{--        @endif--}}
{{--        <span class="pagination-number pagination-left-number" id="left-number">{{$membersData['data']->currentPage()}}</span>--}}
{{--        <span class="pagination-divider">/</span>--}}
{{--        <span class="pagination-number pagination-right-number" id="right-number">{{$membersData['data']->lastPage()}}</span>--}}
{{--        @if($membersData['data']->currentPage() != $membersData['data']->lastPage())--}}
{{--            <a href="{{$membersData['data']->nextPageUrl()}}" data-href="" class="btn right-arrow" id="right-arrow"><i class="fa-solid fa-chevron-right"></i></a>--}}
{{--        @endif--}}
{{--    </div>--}}
{{--</div>--}}
</div>
